...
```{r}
mygraph = read.gexf("tanya-id272426131.gexf")
friends_graph1 = gexf.to.igraph(mygraph)
...
```{r}
print(vcount(friends_graph1))
print(ecount(friends_graph1))
print(sum(degree(friends_graph1) < 1))
print(sum(degree(friends_graph1) < 5))
print(sum(degree(friends_graph1) < 20))
print(sum(degree(friends_graph1) < 30))
print(sum(degree(friends_graph1) < 55))
friends_graph = delete_vertices(friends_graph1, which(degree(friends_graph1) < 120))
print(vcount(friends_graph))
print(ecount(friends_graph))
```
...
plot(friends_graph, layout = friends_graph_layout, main = "Degree Centrality", edge.curved=autocurve.edges(friends_graph),edge.width = 0.3, edge.arrow.size = 0.3,vertex.color = friends_graph_v_color, vertex.size = friends_graph_v_size(friends_graph_degree_cent))
